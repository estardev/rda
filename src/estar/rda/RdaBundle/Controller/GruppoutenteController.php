...
class GruppoutenteController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('gruppoutente_show', array('id' => $entity->getIdgruppo())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new GruppoutenteType(), $entity, array(
            'action' => $this->generateUrl('gruppoutente_update', array('id' => $entity->getIdgruppo())),
            'method' => 'PUT',
        ));
