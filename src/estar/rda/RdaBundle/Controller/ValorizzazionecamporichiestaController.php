...
class ValorizzazionecamporichiestaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('valorizzazionecamporichiesta_show', array('id' => $entity->getIdvalorizzazionecamporichiesta())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new ValorizzazionecamporichiestaType(), $entity, array(
            'action' => $this->generateUrl('valorizzazionecamporichiesta_update', array('id' => $entity->getIdvalorizzazionecamporichiesta())),
            'method' => 'PUT',
        ));
