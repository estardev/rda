...
class CategoriadocumentoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('categoriadocumento_show', array('id' => $entity->getIdcategoriadocumento())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new CategoriadocumentoType(), $entity, array(
            'action' => $this->generateUrl('categoriadocumento_update', array('id' => $entity->getIdcategoriadocumento())),
            'method' => 'PUT',
        ));
