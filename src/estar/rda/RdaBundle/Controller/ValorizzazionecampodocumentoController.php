...
class ValorizzazionecampodocumentoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('valorizzazionecampodocumento_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new ValorizzazionecampodocumentoType(), $entity, array(
            'action' => $this->generateUrl('valorizzazionecampodocumento_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
