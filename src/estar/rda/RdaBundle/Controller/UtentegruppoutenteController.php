...
class UtentegruppoutenteController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('utentegruppoutente_show', array('id' => $entity->getIdutentegruppoutente())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new UtentegruppoutenteType(), $entity, array(
            'action' => $this->generateUrl('utentegruppoutente_update', array('id' => $entity->getIdutentegruppoutente())),
            'method' => 'PUT',
        ));
