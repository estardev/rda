...
//
        ...
        if ($mode == FormTemplateService::MODE_INSERT) {
            ...
            if((!$entity->isCp() OR !$entity->isAssenzaconflitto()) AND $entity->getStatus()!="inviata_ESTAR" AND $entity->getStatus()!="annullata" AND $entity->getStatus()!="eliminata"){
                $messaggio= "<strong><a href=\"http://rda.estar.toscana.it/rdaconcorsi/web/app.php/documento/byCategoria/$idRichiesta/$idCategoria\">RICORDARSI DI ALLEGARE I DOCUMENTI RICHIESTI IN FORMATO PDF</a></strong>";
