 ...
 */
class Categoria extends \estar\rda\RdaBundle\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Categoria' . "\0" . 'descrizione', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Categoria' . "\0" . 'id');
        }
