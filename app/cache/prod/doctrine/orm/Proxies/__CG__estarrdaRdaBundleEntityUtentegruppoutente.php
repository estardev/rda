 ...
 */
class Utentegruppoutente extends \estar\rda\RdaBundle\Entity\Utentegruppoutente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Utentegruppoutente' . "\0" . 'amministratore', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Utentegruppoutente' . "\0" . 'id', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Utentegruppoutente' . "\0" . 'idutente', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Utentegruppoutente' . "\0" . 'idgruppoutente');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Utentegruppoutente $proxy) {
    ...
    public function setAmministratore($amministratore)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAmministratore', array($amministratore));

        return parent::setAmministratore($amministratore);
    }
    ...
    public function getAmministratore()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAmministratore', array());

        return parent::getAmministratore();
    }
