 ...
 */
class Gruppoutente extends \estar\rda\RdaBundle\Entity\Gruppoutente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Gruppoutente' . "\0" . 'nome', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Gruppoutente' . "\0" . 'descrizione', '' . "\0" . 'estar\\rda\\RdaBundle\\Entity\\Gruppoutente' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gruppoutente $proxy) {
