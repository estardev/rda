...
@XmlRootElement(name = "InstanceMessageUpdateResponse")
public class InstanceMessageUpdateResponse {
    ...
    @XmlElementRef(name = "viewUrl", type = JAXBElement.class, required = false)
    protected JAXBElement<String> viewUrl;
     ...
     *     
     */
    public JAXBElement<String> getViewUrl() {
        return viewUrl;
    }
     ...
     *     
     */
    public void setViewUrl(JAXBElement<String> value) {
        this.viewUrl = value;
    }
