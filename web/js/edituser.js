$(document).ready(function()
{
    ...
    $(".gruppiutenteCheckbox input[type='checkbox']").each(function() {
        ...
        if($($classus).is(':checked')){
            //alert("mio"+gruppoVal);
            var isAmministratoreHtml = '<div class="checkbox amministratoriCheckbox_'+ gruppoVal +'"><input type="checkbox" name="amministratoriCheckboxInput[]" value="'+ gruppoVal +'"> Amministratore</label></div>';
            $(this).closest(".checkbox").closest(".form-group").find(".amministratoriCheckbox").append(isAmministratoreHtml);

        }else {
            //alert(gruppoVal);
            var isAmministratoreHtml = '<div class="checkbox amministratoriCheckbox_'+ gruppoVal +'"><label style="color: #999999"><input type="checkbox" name="amministratoriCheckboxInput[]" value="'+ gruppoVal +'" disabled="disabled"> Amministratore</label></div>';
            $(this).closest(".checkbox").closest(".form-group").find(".amministratoriCheckbox").append(isAmministratoreHtml);
